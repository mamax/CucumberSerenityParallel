package com.cucumber.serenity.utils;
...
public class SerenityProperties {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SerenityProperties.class);
    private static final String OS = System.getProperty("os");
    private static final String SERENITY_UNIQUE_PROPERTY_FILE = "src/test/resources/properties/os/" + OS
            + "/serenity.properties";
    private static final String SERENITY_COMMON_PROPERTY_FILE = "src/test/resources/properties/common/serenity_common.properties";
    ...
    private static SerenityProperties instance = new SerenityProperties();
    private Properties properties;

    private SerenityProperties() {
